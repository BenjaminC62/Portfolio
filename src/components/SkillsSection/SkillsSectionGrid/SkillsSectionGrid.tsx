    ...
    return (
        <div className="grid grid-rows-2 grid-cols-2 gap-8 text-center w-[44rem] h-[44rem] relative">
            <div className="relative p-4 flex flex-col justify-center items-center -translate-y-8">
                ...
                <span className="mt-4 font-semibold z-10">database</span>
                <span className="mt-2 text-sm z-10 text-gray-300">lorem</span>
            </div>
            <div className="relative p-4 flex flex-col items-center justify-center">
                ...
                <span className="mt-4 font-semibold">Web developement</span>
                <span className="mt-2 text-sm text-gray-300 ">lorem10</span>
            </div>
            <div className="relative p-4 flex flex-col justify-center items-center -translate-y-8">
                <div className="absolute inset-0 bg-gradient-to-t from-text to-transparent opacity-10"></div>
                ...
                <span className="mt-4 font-semibold">App developement</span>
                <span className="mt-2 text-sm text-gray-300 ">lorem10</span>
            </div>
            <div className="relative p-4 flex flex-col justify-center items-center">
                ...
                <span className="mt-4 font-semibold z-10">Développement de Jeux</span>
                <span className="mt-2 text-sm z-10 text-gray-300">Développement de Jeux</span>
            </div>
        </div>
    );
};
