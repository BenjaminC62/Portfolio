    ...
    return (
        <div className="grid grid-rows-2 grid-cols-2 gap-8 text-center w-[44rem] h-[44rem] relative">
            <div className="relative p-4 flex flex-col justify-center items-center -translate-y-8">
                ...
                <span className="mt-4 font-semibold z-10">{cat4}</span>
                <span className="mt-2 text-sm z-10 text-gray-300">{cat4_desc}</span>
            </div>
            <div className="relative p-4 flex flex-col items-center justify-center">
                ...
                <span className="mt-4 font-semibold">{cat1}</span>
                <span className="mt-2 text-sm text-gray-300 ">{cat1_desc}</span>
            </div>
            <div className="relative p-4 flex flex-col justify-center items-center -translate-y-8">
                <div className="absolute inset-0 bg-gradient-to-t from-text to-transparent opacity-10"></div>
                ...
                <span className="mt-4 font-semibold">{cat2}</span>
                <span className="mt-2 text-sm text-gray-300 ">{cat2_desc}</span>
            </div>
            <div className="relative p-4 flex flex-col justify-center items-center">
                ...
                <span className="mt-4 font-semibold z-10">{cat3}</span>
                <span className="mt-2 text-sm z-10 text-gray-300">{cat3_desc}</span>
            </div>
        </div>
    );
};
